		...
		<div class="vertical-center">
			<div class="w3-container w3-third w3-center w3-grey-shadow-shadow customShadow" style="position:relative;">
				<form action='dbConnection.php' method='post'>
					...
					<div class="w3-margin-top g-recaptcha w3-center w3-margin" data-sitekey="6Lfhs1UUAAAAAKgEXiipK1Bhw2KBRBkaJEBFY4vz" data-callback="enableBtn"></div>
					<br>
					<button id="button1" class="btn w3-block w3-purple w3-hover-shadow w3-hover-text-white w3-round-large nounderline w3-margin-bottom" type='submit' name='submitbuttonL' disabled>Envia</button>
